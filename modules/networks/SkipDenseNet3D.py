...
class SkipDenseNet3D(BaseModel):
    ...
    def __init__(self, in_channels=2, classes=4, growth_rate=16, block_config=(4, 4, 4, 4), num_init_features=32,
        ...
        # nb_features = 123  # 224 x 224 x 24
        # nb_features = 124  # 224 x 224 x 32
        nb_features = 132  # 224 x 224 x 64
    ...
    def forward(self, x):
        ...
        fc1 = nn.functional.adaptive_avg_pool3d(out, (1, 1, 1))
